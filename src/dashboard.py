...
class Dashboard(QWidget):
    def __init__(self):
        ...
        self.cards = []
        self.setup_ui()
        # Refresh otomatis saat pertama kali dibuka
    ...
    def setup_ui(self):
        ...
        # 1. Header Section dengan gradient effect
        ...
        # 2. Container Kartu dengan shadow
        ...
        # 3. Chart Section dengan styling lebih baik
    ...
    def load_cards(self):
        ...
        data = self.get_stats()
        # Definisi dengan gradien dan icon yang lebih menarik
        configs = [
            ("📨 SURAT MASUK", data['masuk'], 
             "qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #667eea, stop:1 #764ba2)", 
             "#5568d3"),
            ("📤 SURAT KELUAR", data['keluar'], 
    ...
    def update_chart(self):
        ...
        # Styling matplotlib yang lebih modern
        plt.style.use('seaborn-v0_8-pastel')
        fig, ax = plt.subplots(figsize=(6, 4))
        fig.patch.set_facecolor('white')
        
        colors = ['#667eea', '#f5576c', '#00f2fe']
        explode = (0.05, 0.05, 0.05)  # Sedikit pisahkan slice
